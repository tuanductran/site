        ...
        <div className="sm:col-span-2">
          ...
          <input
            ...
            className={clsx(
              ...
              'placeholder:text-zinc-400 sm:text-sm appearance-none rounded-adaptive focus:outline-none focus:ring-4 focus:ring-primary/10 focus:border-primary block w-full p-2.5 dark:bg-zinc-700/[0.15] dark:text-zinc-200 dark:border-zinc-700 dark:placeholder:text-zinc-500 dark:focus:border-light dark:focus:ring-light/10',
            )}
